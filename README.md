...
- **How I used it:** Explained some unfamiliar JavaScript concepts relative to my Java/Python background, debugged throughout and helped especially with a variable shadowing bug in `setIncome()`, and helped design the per-month localStorage architecture
...
- **Edit transactions** instead of delete and add again